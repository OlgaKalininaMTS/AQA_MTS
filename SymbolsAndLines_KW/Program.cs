        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            /*
             string str = "teamwithsomeofexcersicesabcwanttomakeitbetter.";
                        ...
                        string ch = "abc";
                       int startAbc = str.IndexOf(ch); // равно 24
                        Console.WriteLine(startAbc);

                        string substring1 = str.Remove(startAbc);    
                        Console.WriteLine($"Символы до \"abc\": {substring1}"); 

                        string substring2 = str.Substring(startAbc+ch.Length);  //  подстрока начиная с указанных символов без учета данных символов (после)
            ...
            */
            ...
            /*
                        ...
                        char[] chars2 = { ' ' };
                        int res = day1.IndexOfAny(chars2);

                        string substring1 = day1.Substring(res);  //вырезать с определенного символа
                      ...
                      //  Console.WriteLine($"Добавили слово \"Хороший\" (в начале): {insertedAtStart}");
                        ...
                        string insertedAtEnd = insertedAtStart.Insert(insertedAtStart.Length - 1, "!!!!!!!!!"); // не забывать пробелы, автоматом не проставятся
                    //    Console.WriteLine($"Insert (в конце): {insertedAtEnd}");

                        string hhh = insertedAtEnd.Remove(insertedAtEnd.Length -2);
                       // Console.WriteLine(hhh);

                        string www = hhh.Insert(hhh.Length, "?."); // не забывать пробелы, автоматом не проставятся
