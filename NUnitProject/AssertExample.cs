...
public class AssertExample
{
    ...
    [Test]
    public void TestListEquality()  // сравнение двух коллекций
    {
    ...
    [Test]
    public void TestCollectionSubset()  // явл ли коллекция подмножеством другой коллекции
    {
    ...
    {
        Assert.Multiple(() =>    // все проверки пройдут
        {
